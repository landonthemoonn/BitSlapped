  ...
  return (
    <div className="w-full min-h-screen p-4 sm:p-8 flex flex-col items-center pb-28">
      ...
      <div className="w-full max-w-7xl mt-8 flex-grow flex flex-col items-center justify-center text-center">
        ...
        <h2 className="text-4xl text-cyan-300 tracking-widest text-glow">Illusions Gallery</h2>
        <p className="text-white text-xl mt-4 max-w-md">
          Get ready for the main stage! The Illusions Gallery is coming soon. This is where the fiercest looks from the community will be showcased.
        </p>
      </div>
    </div>
  );
